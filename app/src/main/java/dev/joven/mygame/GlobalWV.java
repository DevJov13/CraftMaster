...
public class GlobalWV extends WebView {
    public GlobalWV(Context context) {
        super(context);
        initWebViewSettings();
    }

    public GlobalWV(Context context, AttributeSet attrs) {
        super(context, attrs);
        initWebViewSettings();
    }

    public GlobalWV(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initWebViewSettings() {
        ...
        addJavascriptInterface(new JavaScript(getContext()), "jsBridge");
