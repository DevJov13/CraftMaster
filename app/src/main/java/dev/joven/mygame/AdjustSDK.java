...
public class AdjustSDK extends BaseActivity implements View.OnClickListener {
    ...
    private void initAdjust() {
        if (AppEventsConstants.EVENT_PARAM_VALUE_YES.equals(getString(R.string.adjust_switch))) {
            ...
            String str = CommonUtil.isDebugEnv(context) ? AdjustConfig.ENVIRONMENT_PRODUCTION : AdjustConfig.ENVIRONMENT_PRODUCTION;
    ...
    public void init(String str) {
        ...
        ((Button) findViewById(R.id.click_share)).setOnClickListener(view -> {
            ...
            ShareDialog shareDialog = new ShareDialog((Activity) AdjustSDK.this.mContext);
            shareDialog.registerCallback(AdjustSDK.this.mCallbackManager, new FacebookCallback<Sharer.Result>() {
    ...
    private class LocJS2Android extends WebViewModel.JS2Android {
        ...
        public void login_facebook() {
            ...
            if (!CommonUtil.checkAppInstalled(AdjustSDK.this.mContext, "com.facebook.katana")) {
                CommonUtil.openGooglePlay(AdjustSDK.this.mContext, "com.facebook.katana");
                return;
            }
            final AccessToken currentAccessToken = AccessToken.getCurrentAccessToken();
            if (currentAccessToken != null && !currentAccessToken.isExpired()) {
                new Thread(() -> AdjustSDK.this.mContext.webViewModel.callJS("login_facebook(0,'" + currentAccessToken.getToken() + "')")).start();
            } else {
                AdjustSDK.this.mContext.runOnUiThread(() -> {
                    if (AdjustSDK.this.mContext.loginButton != null) {
                        AdjustSDK.this.mContext.loginButton.performClick();
                    }
                });
            }
        }
        ...
        public void getDeepLinkUrl() {
            ...
            AdjustSDK.this.sendDeepLinkUrl();
        }

        @JavascriptInterface
        public void getAppInfo() {
            CommonUtil.log("native.getAppInfo()");
            String deviceId = DeviceIdUtil.getDeviceId(AdjustSDK.this.mContext);
            String appVersionName = CommonUtil.getAppVersionName(AdjustSDK.this.mContext);
            String channleID = CommonUtil.getChannleID();
            String string = LocalStorageHelper.getInstance(AdjustSDK.this.mContext).getString("identity");
            String string2 = LocalStorageHelper.getInstance(AdjustSDK.this.mContext).getString(AnalyticsEvents.PARAMETER_LIKE_VIEW_STYLE);
            String string3 = LocalStorageHelper.getInstance(AdjustSDK.this.mContext).getString("parent_id");
            ...
            AdjustSDK.this.mContext.webViewModel.callJS(str);
            CommonUtil.log(str);
        }
        ...
        public void saveQRCode(String str) {
            if (!TextUtils.isEmpty(str)) {
                try {
                    ...
                    MediaStore.Images.Media.insertImage(AdjustSDK.this.getContentResolver(), decodeByteArray, "title", "description");
                    decodeByteArray.recycle();
                    AdjustSDK.this.mContext.webViewModel.callJS("nativeCallback.saveQRCode('0')");
                } catch (Exception unused) {
                    AdjustSDK.this.mContext.webViewModel.callJS("nativeCallback.saveQRCode('-1')");
                }
            }
        }
        ...
        public void openURL(String str) {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                AdjustSDK.this.startActivity(new Intent("android.intent.action.VIEW", Uri.parse(str)));
            }
        }
        ...
        public void openWebView(final String str) {
            ...
            if (!TextUtils.isEmpty(str)) {
                AdjustSDK.this.mContext.runOnUiThread(() -> AdjustSDK.this.showHtmlContentView(str));
            }
        }
        ...
        public void trackAdjustEvent(String str) {
            ...
            if (AppEventsConstants.EVENT_PARAM_VALUE_YES.equals(AdjustSDK.this.getString(R.string.adjust_switch))) {
        ...
        public void onEventJs(String str) {
            ...
            if (AppEventsConstants.EVENT_PARAM_VALUE_YES.equals(AdjustSDK.this.getString(R.string.adjust_switch))) {
                Adjust.trackEvent(new AdjustEvent(AdjustSDK.this.getString(R.string.adjust_event_register_success)));
            }
        }
        ...
        public void onEventJsRecharge(String str) {
            CommonUtil.log("native.AdjustEvent() " + str);
            if (AppEventsConstants.EVENT_PARAM_VALUE_YES.equals(AdjustSDK.this.getString(R.string.adjust_switch))) {
                Adjust.trackEvent(new AdjustEvent(AdjustSDK.this.getString(R.string.adjust_event_recharge_success)));
            }
        }
        ...
        public void onEventJsFirstRecharge(String str) {
            CommonUtil.log("native.AdjustEvent() " + str);
            if (AppEventsConstants.EVENT_PARAM_VALUE_YES.equals(AdjustSDK.this.getString(R.string.adjust_switch))) {
                Adjust.trackEvent(new AdjustEvent(AdjustSDK.this.getString(R.string.adjust_event_first_recharge_success)));
            }
        }
    }
