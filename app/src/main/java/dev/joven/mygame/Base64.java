...
public final class Base64 {
    ...
    public static String encode(byte[] bArr) {
        ...
        while (i3 < i2) {
            ...
            byte b4 = (byte) (b2 & 15);
            byte b5 = (byte) (b & 3);
            byte b6 = (byte) (b & ByteCompanionObject.MIN_VALUE);
            int i9 = b >> 2;
            if (b6 != 0) {
                i9 ^= 192;
            }
            byte b7 = (byte) i9;
            byte b8 = (byte) (b2 & ByteCompanionObject.MIN_VALUE);
            int i10 = b2 >> 4;
            if (b8 != 0) {
                i10 ^= 240;
            }
            byte b9 = (byte) i10;
            int i11 = (b3 & ByteCompanionObject.MIN_VALUE) == 0 ? b3 >> 6 : (b3 >> 6) ^ 252;
            int i12 = i5 + 1;
        ...
        if (i == 8) {
            byte b10 = bArr[i4];
            byte b11 = (byte) (b10 & 3);
            byte b12 = (byte) (b10 & ByteCompanionObject.MIN_VALUE);
            int i15 = b10 >> 2;
            if (b12 != 0) {
                i15 ^= 192;
            }
            ...
            byte b16 = (byte) (b13 & 3);
            byte b17 = (byte) (b13 & ByteCompanionObject.MIN_VALUE);
            int i18 = b13 >> 2;
            if (b17 != 0) {
                i18 ^= 192;
            }
            byte b18 = (byte) i18;
            byte b19 = (byte) (b14 & ByteCompanionObject.MIN_VALUE);
            int i19 = b14 >> 4;
            if (b19 != 0) {
                i19 ^= 240;
            }
